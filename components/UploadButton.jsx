...
export default function UploadButton({ label, onFilePicked, color, loading }) {
  ...
  return (
    <Button color={color} onClick={handleClick} loading={loading}>
      <div className="flex">
        <svg
          aria-hidden="true"
          focusable="false"
          ...
          style={{ width: "0.8rem", transform: "rotate(180deg)" }}
        >
          <path
            fill="currentColor"
